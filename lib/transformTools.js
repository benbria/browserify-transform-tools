  ...
  exports.makeStringTransform = function(transformName, options, transformFn) {
    ...
    transform = function(file) {
      ...
      write = function(buf) {
        ...
        doTransform = function(configData) {
          var err, transformOptions;
          try {
            transformOptions = {
              file: file,
        ...
        if (transform.configData) {
          return process.nextTick(function() {
            return doTransform(transform.configData);
          });
        } else {
