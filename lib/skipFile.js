...
(function() {
  ...
  exports.isJsFile = function(file) {
    var answer, extension, _i, _len;
    answer = false;
    for (_i = 0, _len = JS_EXTENSIONS.length; _i < _len; _i++) {
      extension = JS_EXTENSIONS[_i];
  ...
  exports.skipFile = function(file, configData, options) {
